...
st.set_page_config(page_title="ResumeOptimizer.ai", page_icon=":briefcase:", layout="wide")

# App title and description
st.title("ResumeOptimizer.ai")
st.markdown("Optimize your resume for ATS with AI-driven insights and personalized suggestions!")
...
st.sidebar.markdown(
    ...
    <p style="text-align: center; font-size: 12px; color: #888;">
        <small>Created with ❤️ by <a href="https://www.linkedin.com/in/soumyajit-bhandary-20b348254/" target="_blank" style="color: #0078D4;">Soumyajit Bhandary</a></small>
    </p>
    """,
...
with st.container():
    ...
    jd_input = st.text_area(
        ...
        key="text",
        height=150,
        help="Paste the job description you are applying to. This will be used to tailor your resume."
    )

    uploaded_file = st.file_uploader("Upload Your Resume (PDF)", type=["pdf"], key="file_uploader", label_visibility="collapsed")
    if uploaded_file:
